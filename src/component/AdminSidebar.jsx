      ...
      >
        ...
        <div className="mt-6">
          ...
          {openSection === "appointment" && (
            <div className="ml-4">
              <Link to="/admin/add-appointment" className="block p-2 hover:bg-blue-700">
                Add Appointment
              </Link>
              <Link to="/admin/appointment-list" className="block p-2 hover:bg-blue-700">
                Appointment List
              </Link>
            </div>
          )}
          ...
          {openSection === "patients" && (
            <div className="ml-4">
              <Link to="/admin/patient-list" className="block p-2 hover:bg-blue-700">
                Patient List
              </Link>
              <Link to="/admin/patient-history" className="block p-2 hover:bg-blue-700">
                Patient History
              </Link>
            </div>
          )}
          ...
          {openSection === "services" && (
            <div className="ml-4">
              <Link to="/admin/add-services" className="block p-2 hover:bg-blue-700">
                Add Services
              </Link>
              <Link to="/admin/manage-services" className="block p-2 hover:bg-blue-700">
                Manage Services
              </Link>
            </div>
          )}
